...
import { WorkArea, WorkAreaDocument, WorkAreaFormatter } from "../../modules/work-areas/types";
...
export interface AppDatabase {
    ...
    workAreaDocument: Table<WorkAreaDocument>;
    workAreaFormatter: Table<WorkAreaFormatter>;
}
